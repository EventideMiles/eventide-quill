...
export const RULE_INFO: Record<string, RuleInfo> = {
    ...
    'telling-vs-showing': {
        ...
        description: 'Flags direct emotion-naming (he was angry, she felt sad) where showing through action or dialogue would be stronger.',
        example: 'Instead of "He was nervous," describe clammy hands, darting eyes, or a wavering voice.',
    },
    'dialogue-tags': {
        name: 'Dialogue tags',
        description: 'Flags non-"said" and non-"asked" dialogue tags used more than once (whispered, murmured, growled, etc.). "Said" and "asked" are invisible and never flagged.',
    ...
    'ai-hedging': {
        ...
        description: 'Flags hedging words (might, could, perhaps, maybe, sort of, in a sense, etc.) that weaken certainty.',
