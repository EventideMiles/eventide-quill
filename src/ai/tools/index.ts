...
import { deleteParagraphTool } from './delete-paragraph';
import { addWorldRuleTool } from './add-world-rule';
...
export { deleteParagraphTool } from './delete-paragraph';
export { addWorldRuleTool } from './add-world-rule';
...
export function createInternalToolRegistry(opts?: InternalToolOptions): ToolRegistry {
    ...
    registry.register(deleteParagraphTool);
    registry.register(addWorldRuleTool);
