...
export function getReviewDiscussSystemPrompt(
    ...
    if (!engine || engine === 'generic') {
        return [
            ...
            '',
            'Keep edits SURGICAL. Change the minimum text needed.',
            '- If the writer asks to fix ONE paragraph, edit ONE paragraph.',
            '  Leave surrounding paragraphs untouched.',
            '- If the writer asks to ADD one paragraph, insert one paragraph.',
            '  Do not pad with extra context or bundle in neighboring fixes.',
            '- Your new_text should contain ONLY the paragraph being rewritten',
            '  or added. Do not include surrounding text as context.',
            '',
    ...
    return [
        ...
        '## Scope discipline (critical)',
        '',
        'Keep edits SURGICAL. Change the minimum text needed to address the',
        'writer\u2019s request.',
        '- If the writer asks to fix ONE paragraph, edit ONE paragraph. Leave',
        '  surrounding paragraphs untouched even if you think they could be',
        '  improved. Unsolicited improvements to nearby text create noise.',
        '- If the writer asks to ADD one paragraph, insert one paragraph.',
        '  Do not pad with extra context, restate existing text, or bundle in',
        '  improvements to neighboring paragraphs.',
        '- Your new_text should contain ONLY the paragraph being rewritten or',
        '  added. Do not include surrounding paragraphs as "context" \u2014 they',
        '  are already in the file and do not need to be restated.',
        '',
        '## Tool discipline (critical)',
        '',
