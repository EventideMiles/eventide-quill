...
export function getReviewDiscussSystemPrompt(
    ...
    if (!engine || engine === 'generic') {
        return [
            ...
            '- When the writer agrees to a change, CALL THE TOOL IMMEDIATELY in',
            '  this same response. Do NOT describe what you plan to do ("I\'ll get',
            '  started on those edits") and then stop — the writer cannot see your',
            "  intent unless you actually call the tool. Act, don't narrate.",
    ...
    return [
        ...
        '- Do NOT propose edits preemptively. Wait for the writer to ask for',
        '  or agree to a specific change. If your advice is "consider tightening this',
