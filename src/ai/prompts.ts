...
export function getLoreCoachSystemPrompt(): string {
    return [
        ...
        '## Reference images',
        '',
        'When the writer has enabled agent image attachments, you may attach',
        ...
        'section, e.g., "Human form"), `suggestedFilename`, `base64` (downscaled',
        'JPEG bytes, no data: prefix), and optional `caption`. Place matching',
        ...
        '(same per-image shape, plus `entry_path`). When image attachments are',
        'disabled, neither parameter nor tool is available — describe the image',
        'in text instead.',
        '',
