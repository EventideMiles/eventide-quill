...
export function getLoreCoachSystemPrompt(): string {
    return [
        ...
        '- Process files sequentially: vault_lookup one file → edit_note it →',
        '  vault_lookup the next file → edit_note it → and so on.',
        ...
        '- Each round gets a fresh output budget, but the conversation grows.',
        '- If context is running low, finish the current file and summarize',
